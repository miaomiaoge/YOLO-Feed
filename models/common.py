...
class RefConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride, padding=None, groups=1,dilation=None,
                 map_k=3):
        ...
        self.convmap = nn.Conv2d(in_channels=self.num_2d_kernels,
                                 ...
                                 groups=G, dilation=dilation,bias=False)
...
class Conv(nn.Module):
    ...
    def __init__(self, c1, c2, k=1, s=1, p=None, g=1, d=1, act=True):
        ...
        if k==3:
            self.conv = RefConv(c1,c2,k,s,autopad(k, p, d), groups=g, map_k=3, dilation=d)
        else:
